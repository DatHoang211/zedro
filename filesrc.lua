...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Zedro Hub chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Zedro Hub", HidePremium = false, IntroText = "Zedro Hub⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("Zedro Hub SCRIPT")
W:AddLabel("DiscordZedro Hub")
local Section = W:AddSection({
    Name = "Status"
})
